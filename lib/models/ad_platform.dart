...
class AppLovin {
    ...
    AppLovinMAX.setInterstitialListener(InterstitialListener(
      ...
      onAdLoadFailedCallback: (adUnitId, error) {
        ...
        Future.delayed(Duration(milliseconds: retryDelay * 1000), () {
          AppLovinMAX.loadInterstitial(appLovinAdUnit);
        });
      },
  ...
  Future<void> showInterstitialAd() async {
    bool isReady = (await AppLovinMAX.isInterstitialReady(appLovinAdUnit))!;
    if (isReady) {
      AppLovinMAX.showInterstitial(appLovinAdUnit);
    }
  }
}
...
//   final String rewardedAdUnitId = adMobAdUnit;
//
//   void loadRewardedAd() {
//     RewardedAd.load(
